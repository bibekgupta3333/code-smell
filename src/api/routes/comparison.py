...
async def comparison_summary():
    ...
    Example:
        ...
        Response:
        {
            ...
            "performance": {
                ...
                "baseline_avg_time_ms": 1850,
                "slowest_tool": "sonarqube",
                "fastest_tool": "checkstyle"
            }
        }
    """
    ...
    for comp_data in comparison_cache.values():
        ...
        # Agreement calculation (simplified)
    ...
    avg_analysis_time = total_analysis_time / total if total > 0 else 0
